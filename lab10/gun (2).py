...
class BattleField(tk.Canvas):
    def __init__(self, master):
        ...
        print(self.gun2.gun_coords)
        self.targets = {}
        self.bullets = {}
        self.bind("<Control-d>", self.change_gun)
        self.change_gun_flag = False #changes here
